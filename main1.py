"CE CODE MARCHE MAIS SEULEMENT AVEC MARIO LA JV FAIRE LE NINJA"
...
class Jeu:
    def __init__(self):
        ...
        self.plateforme_liste_rect = [
            pygame.Rect(0, 580, 300, 50), pygame.Rect(700, 580, 300, 50),
            pygame.Rect(340, 480, 300, 50), pygame.Rect(250, 310, 50, 50),
        ]
